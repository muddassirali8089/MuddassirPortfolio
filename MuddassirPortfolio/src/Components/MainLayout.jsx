                ...
                <div className="owl-carousel testimonial-slider owl-theme">
                  <div className="testimonial-item">
                    <div className="testimonial-item-inner">
                      ...
                      <p>
                        ...
                        master of code. Much more than what i'm expect. High
                  ...
                  <div className="testimonial-item">
                    <div className="testimonial-item-inner">
                      ...
                      <p>
                        “Drake was a real pleasure to work with and we look
                        forward to working with him again. He's definitely the
                        kind of designer that you can trust with any project from
                        A-Z.”
                      </p>
                      <a href="#" className="project-btn">
                        Project
                  ...
                  <div className="testimonial-item">
                    <div className="testimonial-item-inner">
                      ...
                      <p>
                        ...
                        master of code and he also very creative. We done 3
                        projects with him and certain will continue.”
                      </p>
                      <a href="#" className="project-btn">
                        Project
                      </a>
