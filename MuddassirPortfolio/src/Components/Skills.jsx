...
const skillsData = [
  { name: "React", imgSrc: "https://static-00.iconduck.com/assets.00/react-icon-1024x911-1chjdhzi.png", percent: "90%" },
  { name: "Node.js", imgSrc: "https://pluspng.com/img-png/nodejs-png-nodejs-icon-png-50-px-1600.png", percent: "85%" },
  { name: "MongoDB", imgSrc: "https://images.icon-icons.com/2415/PNG/512/mongodb_original_logo_icon_146424.png", percent: "80%" },
        ...
        <div className="skills-content content-width">
          ...
          <div className="row skills text-center">
            {skillsData.map((skill, index) => (
              <div
                key={index}
                className={`col-md-3 scroll-animation ${index % 2 === 0 ? 'fade-left' : 'fade-up'}`}
                data-aos={index % 2 === 0 ? 'fade-left' : 'fade-up'}
                data-aos-delay={`${index * 100}`}
              >
                <div className="skill">
                  <div className="skill-inner">
                  <img src={skill.imgSrc} alt={skill.name} style={{ width: '70%', height: 'auto' }} />
